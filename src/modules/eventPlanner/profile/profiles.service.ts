...
export async function getProfiles(sort: keyof UserProfile = "name", sortOrder: "asc" | "desc" = "desc", limit = 100, page = 1, includes: AuctionProfileIncludes = {}) {
...
export async function getProfileBids(name: string, sort: keyof AuctionBid = "created", sortOrder: "asc" | "desc" = "desc", limit = 100, page = 1, includes: { listing?: boolean } = {}) {
...
export async function getProfileWins(name: string, sort: keyof AuctionListing = "created", sortOrder: "asc" | "desc" = "desc", limit = 100, page = 1, includes: AuctionListingIncludes = {}) {
...
export async function searchProfiles(sort: keyof UserProfile = "name", sortOrder: "asc" | "desc" = "desc", limit = 100, page = 1, query: string, includes: AuctionProfileIncludes = {}) {
  const withListingMedia = includes.listings ? { listings: { include: { media: true } } } : {};
  const withWinsMedia = includes.wins ? { wins: { include: { media: true } } } : {};
