...
import { profileNameSchema, profilesQuerySchema, queryFlagsSchema, searchQuerySchema, updateProfileSchema, UpdateProfileSchema } from "./profiles.schema";
import { getProfile, getProfileBids, getProfileListings, getProfiles, getProfileWins, searchProfiles, updateProfile } from "./profiles.service";
...
export async function getProfilesHandler(
  ...
  const profiles = await getProfiles(sort, sortOrder, limit, page);
